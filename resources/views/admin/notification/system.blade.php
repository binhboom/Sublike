    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.notify.system.create') }}" method="POST">
                        @csrf
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            @foreach ($noticeSystems as $notification)
                                <tr>
                                    <td>{{ $notification->id }}</td>
                                    <td>
                                        <a href="{{ route('admin.notify.system.delete', ['id' => $notification->id]) }}"
