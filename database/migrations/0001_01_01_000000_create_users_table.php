...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('telegram_link')->nullable()->comment('Đường dẫn tới telegram của người dùng');
            $table->string('telegram_id')->nullable()->comment('ID telegram của người dùng');
            $table->enum('notification_email', ['yes', 'no'])->default('yes')->comment('Cho phép gửi thông báo qua email');
            $table->enum('notification_telegram', ['yes', 'no'])->default('yes')->comment('Cho phép gửi thông báo qua telegram');
            ...
            $table->longText('access_login')->nullable();
            ...
            $table->timestamp('login_expired_at')->nullable();
            $table->rememberToken();
            $table->timestamps();
